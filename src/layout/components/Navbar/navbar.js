	...
	return (
		<Disclosure as="nav" className="bg-green-100">
			{({ open }) => (
				<>
					{/* check out */}
					<Cart Open={isCart} handleOpen={handleCart} />
					<div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
						<div className="relative flex h-16 items-center justify-between">
							...
							<div className="absolute inset-y-0 right-[20%] sm:right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
								<button
									type="button"
									...
									{user ? (
										<div className="static">
											<Menu.Button className="flex rounded-full bg-gray-800 text-sm focus:outline-none">
												...
												<img className="h-8 w-8 rounded-full" src={'profile?.images[0]'} alt="" />
