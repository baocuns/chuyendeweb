...
export default function DetailTour() {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get(`${DETAIL_TOUR_ROUTE}/ha-noi-vinh-ha-long-chua-bai-dinh-trang-an-tuyet-tinh-coc-1667760176550`)
            ...
            <div className="pt-6">
                ...
                <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
                    {tour && tour.images.map((item, index) => {
                        return (
                            <div className="aspect-w-3 aspect-h-4 hidden overflow-hidden rounded-lg lg:block m-3">
                                <img
                                    src={item}
                                    alt={item}
