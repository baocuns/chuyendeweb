        ...
        >
            ...
            >
                <div className="flex flex-col w-full">
                    {order && (
                        <div>
                            <div className="flex flex-col justify-start items-start border w-full p-4 md:p-8 rounded">
                                    ...
                                    <div className="flex my-8 flex-row items-end w-full">
                                        ...
                                        <div className="flex flex-col w-full space-y-2">
                                            <div className="flex justify-between w-full items-center">
                                                ...
                                                <p className="text-lg font-thin leading-4 text-black">{order.user[0].fullname}</p>
                                            </div>
                                            <div className="flex justify-between w-full items-center">
                                                <p className="text-lg leading-4 text-black">Email:</p>
                                                <p className="text-lg font-thin leading-4 text-black">{order.user[0].email}</p>
                                            </div>
                                            <div className="flex justify-between w-full items-center">
                                                <p className="text-lg leading-4 text-black">Số điện thoại:</p>
                                                <p className="text-lg font-thin leading-4 text-black">{order.user[0].phone}</p>
                                            </div>
                                            <div className="flex justify-between w-full items-center">
                                                <p className="text-lg leading-4 text-black">Địa chỉ:</p>
                                                <p className="text-lg font-thin leading-4 text-black">{order.user[0].address}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4">
                                <ul role="list" className="-my-6 divide-y divide-gray-200">
                                    {order && order.tours.map((tour, index) => (
                                            ...
                                            <div className="ml-4 flex flex-1 flex-col">
                                                <div>
                                                    ...
                                                    <p className="mt-1 text-xs md:text-sm text-gray-500 flex items-center">
                                                        {tour.address_start} <Hi.HiArrowRight className='mx-1 text-red-500' /> {tour.address_end}
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
