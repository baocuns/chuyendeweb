...
const Details = () => {
  ...
  const handleSubmit = () => {
    ...
    Axios.put(`${API_HOST}/api/v1/service/update/${tour?._id}`, formData, {
      headers: {
  ...
  useEffect(() => {
    axios
      .get(`${API_HOST}/api/v1/tour/show/details/${slug}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`${API_HOST}/api/v1/area/show/all`)
      .then((result) => {
  ...
  return (
    <div className="bg-white">
      {/* loader */}
      {api.isFetching && <Components.Loader />}
      <div className="pt-6">
        {/* Image gallery */}
        <div className="relative w-full flex snap-x gap-6 overflow-x-auto pb-14">
          {tour &&
            tour.images.map((e, index) => (
              <div
                key={index}
                className="snap-center shrink-0 hover:opacity-75 hover:cursor-pointer"
              >
                <img
                  src={e}
                  alt={tour.title}
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-4 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="w-full flex">
              ...
              />
              <div className="text-3xl text-gray-900 tracking-tight mr-2">
                vnđ
              </div>
            </div>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pb-16 lg:pr-8">
                    ...
                    >
                      ...
                      {areas &&
                        areas.map((area, index) => (
                          <option key={index} value={area.slug}>
                            {area.title}
                          </option>
                        ))}
                    </select>
            ...
            <div className="mt-10">
                  ...
                  <div className="mt-4 space-y-2 border p-2">
                    <div className="flex justify-between">
                      <input
                        ...
                        onChange={(el) =>
                          handleScheduleChange(el.target, index)
                        }
                        className="focus:outline-0 sm:text-sm text-black font-bold"
                      />
                      <div>
                        <button onClick={() => handleScheduleDelete(index)}>
              ...
              <div className="flex items-center mt-4">
                ...
                <button
                  className="ml-2 py-2 px-4 bg-green-400 hover:bg-green-500 flex justify-center items-center rounded"
        ...
        <div className="p-4 mb-16 flex justify-start">
          <button
            className="bg-green-500 p-2 rounded text-white hover:cursor-point hover:bg-green-600"
            onClick={handleOpenAlert}
          >
            Save Change
          </button>
          <button
            className="bg-red-500 p-2 rounded text-white hover:cursor-point hover:bg-red-600 ml-4"
