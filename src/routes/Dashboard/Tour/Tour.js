        ...
        <div>
            <div className='flex justify-end mr-8 mt-4'>
                <div className="inline-flex rounded-md shadow-sm mr-2" role="group">
                    ...
                    <button type="button" className="py-2 px-4 text-sm font-medium text-gray-900 bg-white rounded-r-md border border-gray-200 hover:bg-gray-100 hover:text-green-400 focus:z-10 focus:bg-green-400 focus:text-white">
                        <Ci.CiGrid41 size={24} />
                    </button>
                </div>

                <button className='py-2 px-4 bg-green-400 hover:bg-green-500 flex justify-center items-center rounded'
                    onClick={handlePlus}
                >
